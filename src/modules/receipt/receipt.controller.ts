import { Controller, Post, UploadedFile, UseInterceptors, BadRequestException, UsePipes } from '@nestjs/common';
...
export class ReceiptController {
    ...
    @ApiOkResponse({ description: responseMessage.success, type: IReturnReceiptData })
    @ApiBadRequestResponse({ description: responseMessage.badRequest, type: ExceptionDto })
